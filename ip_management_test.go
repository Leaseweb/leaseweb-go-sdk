...
func TestIpManagementListIps(t *testing.T) {
	...
	assert.Equal(Ip1.PrefixLength, 32)
	...
	assert.Equal(Ip2.Subnet.PrefixLength, 24)
...
func TestIpManagementGetIps(t *testing.T) {
	...
	assert.Equal(Ip.PrefixLength, 32)
	...
	assert.Equal(Ip.Subnet.PrefixLength, 24)
...
func TestIpManagementNullRouteIp(t *testing.T) {
	...
	assert.Equal(NullRoute.NullLevel, 1)
...
func TestIpManagementListNullRouteHistory(t *testing.T) {
	...
	assert.Equal(NullRoute1.NullLevel, 1)
	...
	assert.Equal(NullRoute2.NullLevel, 1)
