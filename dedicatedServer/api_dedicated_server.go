...
*/
func (a *DedicatedServerAPIService) ConfigureHardwareRaid(ctx context.Context, serverId string) ApiConfigureHardwareRaidRequest {
	return ApiConfigureHardwareRaidRequest{
		ApiService: a,
		ctx: ctx,
		serverId: serverId,
...
func (a *DedicatedServerAPIService) ConfigureHardwareRaidExecute(r ApiConfigureHardwareRaidRequest) (*ServerJobList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DedicatedServerAPIService.ConfigureHardwareRaid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *DedicatedServerAPIService) GetServerHardwareScan(ctx context.Context, serverId string, hardwareScanId string) ApiGetServerHardwareScanRequest {
	return ApiGetServerHardwareScanRequest{
		ApiService: a,
		ctx: ctx,
		serverId: serverId,
...
func (a *DedicatedServerAPIService) GetServerHardwareScanExecute(r ApiGetServerHardwareScanRequest) (*GetServerHardwareScanResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DedicatedServerAPIService.GetServerHardwareScan")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetServerHardwareScanListRequest struct {
	ctx context.Context
	ApiService *DedicatedServerAPIService
	serverId string
	limit *int32
...
// Limit the number of results returned.
func (r ApiGetServerHardwareScanListRequest) Limit(limit int32) ApiGetServerHardwareScanListRequest {
	r.limit = &limit
	return r
}

// Return results starting from the given offset.
func (r ApiGetServerHardwareScanListRequest) Offset(offset int32) ApiGetServerHardwareScanListRequest {
	r.offset = &offset
	return r
}

func (r ApiGetServerHardwareScanListRequest) Execute() (*GetServerHardwareScanListResult, *http.Response, error) {
	return r.ApiService.GetServerHardwareScanListExecute(r)
}

/*
GetServerHardwareScanList List hardware scans
...
List all hardware scans for this server.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param serverId The ID of a server
 @return ApiGetServerHardwareScanListRequest
*/
func (a *DedicatedServerAPIService) GetServerHardwareScanList(ctx context.Context, serverId string) ApiGetServerHardwareScanListRequest {
	return ApiGetServerHardwareScanListRequest{
		ApiService: a,
		ctx: ctx,
		serverId: serverId,
...
func (a *DedicatedServerAPIService) GetServerHardwareScanListExecute(r ApiGetServerHardwareScanListRequest) (*GetServerHardwareScanListResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DedicatedServerAPIService.GetServerHardwareScanList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
This API call is intended to be used _only_ by IPAM to announce or withdraw
null routes.
...
*/
func (a *DedicatedServerAPIService) UpdateNullRoute(ctx context.Context) ApiUpdateNullRouteRequest {
	return ApiUpdateNullRouteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DedicatedServerAPIService) UpdateNullRouteExecute(r ApiUpdateNullRouteRequest) (*UpdateNullRouteAcceptedResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DedicatedServerAPIService.UpdateNullRoute")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
