...
/*
AddServerCredential Create new server credentials
...
/*
GetControlPanelListByOperatingSystem List control panels by Operating System
...
*/
func (a *BmpAPIService) GetNetworkEquipmentCredentialList(ctx context.Context, networkEquipmentId string) ApiGetNetworkEquipmentCredentialListRequest {
	return ApiGetNetworkEquipmentCredentialListRequest{
		ApiService: a,
		ctx: ctx,
		networkEquipmentId: networkEquipmentId,
...
func (a *BmpAPIService) GetNetworkEquipmentCredentialListExecute(r ApiGetNetworkEquipmentCredentialListRequest) (*CredentialList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BmpAPIService.GetNetworkEquipmentCredentialList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
/*
NetworkEquipmentsCredentialsGet Show network equipment credentials
...
/*
NetworkEquipmentsCredentialsPost Create new network equipment credentials
...
func (a *BmpAPIService) RetryServerJobExecute(r ApiRetryServerJobRequest) (*CurrentServerJob, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
/*
ServersCredentialsGet Show server credentials
...
/*
ServersCredentialsListType List server credentials by type
...
/*
ServersCredentialsPut Update server credentials
...
func (r ApiServersJobsGetRequest) Execute() (*CurrentServerJob, *http.Response, error) {
...
// Execute executes the request
//  @return CurrentServerJob
func (a *BmpAPIService) ServersJobsGetExecute(r ApiServersJobsGetRequest) (*CurrentServerJob, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
