...
func Test_bmp_BmpAPIService(t *testing.T) {
	...
	t.Run("Test BmpAPIService GetNetworkEquipmentCredentialList", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var networkEquipmentId string

		resp, httpRes, err := apiClient.BmpAPI.GetNetworkEquipmentCredentialList(context.Background(), networkEquipmentId).Execute()
