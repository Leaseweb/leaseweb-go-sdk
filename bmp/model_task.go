...
type Task struct {
	...
	StatusTimestamps map[string]interface{} `json:"statusTimestamps,omitempty"`
...
// SetStatusTimestamps gets a reference to the given map[string]interface{} and assigns it to the StatusTimestamps field.
