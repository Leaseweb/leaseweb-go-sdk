...
------------ | ------------- | ------------- | -------------
**Id** | Pointer to **string** | The unique ID of this operating system | [optional] 
**Name** | Pointer to **string** | A human readable name describing the operating system | [optional] 
