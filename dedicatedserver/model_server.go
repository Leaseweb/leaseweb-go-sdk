...
type Server struct {
	...
	// List of features that are available for this server
	FeatureAvailability map[string]interface{} `json:"featureAvailability,omitempty"`
	// Id of the server
	Id *string `json:"id,omitempty"`
	// Location of the server
	Location map[string]interface{} `json:"location,omitempty"`
	// Network interface information grouped by type
...
// SetContract gets a reference to the given map[string]interface{} and assigns it to the Contract field.
...
// SetFeatureAvailability gets a reference to the given map[string]interface{} and assigns it to the FeatureAvailability field.
