...
type GetServerHardwareScanResult struct {
	...
	Result *HardwareScanResult `json:"result,omitempty"`
...
// SetResult gets a reference to the given HardwareScanResult and assigns it to the Result field.
