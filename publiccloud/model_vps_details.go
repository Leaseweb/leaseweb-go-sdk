...
// checks if the VpsDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpsDetails{}

// VpsDetails struct for VpsDetails
type VpsDetails struct {
	Id string `json:"id"`
...
func (o VpsDetails) MarshalJSON() ([]byte, error) {
...
func (o VpsDetails) ToMap() (map[string]interface{}, error) {
...
func (o *VpsDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varVpsDetails := _VpsDetails{}

	err = json.Unmarshal(data, &varVpsDetails)

	if err != nil {
		return err
	}

	*o = VpsDetails(varVpsDetails)
...
type NullableVpsDetails struct {
	value *VpsDetails
	isSet bool
}

func (v NullableVpsDetails) Get() *VpsDetails {
	return v.value
}

func (v *NullableVpsDetails) Set(val *VpsDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableVpsDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableVpsDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpsDetails(val *VpsDetails) *NullableVpsDetails {
	return &NullableVpsDetails{value: val, isSet: true}
}

func (v NullableVpsDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpsDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
